...
const SVC_URL = "https://appadaycreator.com/posture-improvement-planner/";
const SVC_NAME = "姿勢改善プランナー";

test.describe("姿勢改善プランナー - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("posture-improvement-planner");
